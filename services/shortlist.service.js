  ...
  const pipeline = [
    ...
    },
    {
      $project: {
        ...
        'address.updatedAt': 1,
        'userList.name': 1,
        'userList.appUsesType': 1,
        'userList.email': 1,
        'userList.mobileNumber': 1,
        'userList.emailVerified': 1,
        'userList.maritalStatus': 1,
        'userList.displayName': 1,
        'userList.firstName': 1,
        'userList.lastName': 1,
        'userList.gender': 1,
        'userList.dateOfBirth': 1,
        'userList.randomId': 1,
        'userList.birthTime': 1,
        'userList.religion': 1,
        'userList.cast': 1,
        'userList.hobbies': 1,
        'userList.interest': 1,
        'userList.homeMobileNumber': 1,
        'userList.creatingProfileFor': 1,
        'userList.writeBoutYourSelf': 1,
        'userList.hideProfileDuration': 1,
        'userList.community': 1,
        'userList.motherTongue': 1,
        'userList.weight': 1,
        'userList.userEducation': 1,
